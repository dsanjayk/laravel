                    ...
                    <form action="{{route('category.update',$category->id)}}" method="post">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 {{$category->is_parent == 1 ? 'd-none' : ''}}" id="parent_cat_div">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" placeholder="Summary" id="summary" name="summary">{{$category->summary}}</textarea>
                                    </div>
                                </div>
